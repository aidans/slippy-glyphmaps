        ...
        if (
          ...
          if (!grid[colRow[0]][colRow[1]]) {
            grid[colRow[0]][colRow[1]] = {
              getBoundary: (padding) => discretiser.getBoundary(colRow[0], colRow[1],padding),
              getXCentre: () => discretiser.getXYCentre(colRow[0], colRow[1])[0]+grid.xOffset,
              getYCentre: () => discretiser.getXYCentre(colRow[0], colRow[1])[1]+grid.yOffset,
          ...
          else for (const aggrFn1 of aggrFn)
              if (aggrFn1) aggrFn1(
                grid[colRow[0]][colRow[1]],
                datum,
                colRow[2] ? colRow[2] : 1,
