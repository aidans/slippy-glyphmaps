...
// A modified version of L.CanvasLayer from the original prompt, converted to an ES module.
export const CanvasLayer = (L.Layer ? L.Layer : L.Class).extend({
  ...
  _updatePosition: function () {
    // Position the canvas at the top-left of the map container
    L.DomUtil.setPosition(this._canvas, [0, 0]);
  },
