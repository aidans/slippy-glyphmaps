              ...
              if (
                ...
                y + ky < numRows
                  ...
                  if (propertyTypes[j] === "value") {
                    ...
                    else //grid and other hex conditions
                      w = wMatrix[kx] ? wMatrix[kx][ky] : 0;
                    ...
                    if (w > 0) {
                      ...
                      for (let i = 0; i < array.length; i++) {
                        ...
                        newV[i] = newV[i]!==undefined && newV[i] ? newV[i] + v * w : v * w;
                      }
                    }
                  }
                }//
              ...
              if (newV / cumW > 0) {
                ...
                if (!grid[x][y])
                  grid[x][y] = {
                    ...
                    getXCentre: () => discretiser.getXYCentre(x,y)[0]+grid.xOffset,
                    getYCentre: () => discretiser.getXYCentre(x,y)[1]+grid.yOffset,
